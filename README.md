# Aimee module: response-composition

This is the independent `response-composition` source-ownership repository.

It builds `aimee-module-response-composition` as a separate Go process for the
